...
GITHUB_TOKEN_FILE="grading_token.txt" classdock secrets add --config assignment.conf --secrets "GRADING_TOKEN"
GITHUB_TOKEN_FILE="api_token.txt" classdock secrets add --config assignment.conf --secrets "API_KEY"
```
